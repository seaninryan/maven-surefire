...
public class PpidCheckerTest
{
    ...
    {
        assertThat( PpidChecker.UNIX_CMD_OUT_PATTERN.matcher( "38" ).matches() )
                .isFalse();

        assertThat( PpidChecker.UNIX_CMD_OUT_PATTERN.matcher( "05:38" ).matches() )
                .isTrue();

        assertThat( PpidChecker.UNIX_CMD_OUT_PATTERN.matcher( "00:05:38" ).matches() )
                .isTrue();

        assertThat( PpidChecker.UNIX_CMD_OUT_PATTERN.matcher( "01:05:38" ).matches() )
                .isTrue();

        assertThat( PpidChecker.UNIX_CMD_OUT_PATTERN.matcher( "02-01:05:38" ).matches() )
                .isTrue();
    }
